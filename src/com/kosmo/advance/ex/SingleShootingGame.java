...
public class SingleShootingGame extends JPanel implements ActionListener {
    ...
    Image[] playerImages;
    Image backgroundImage, enemyImage, finalBossImage, bossImage;
    int selectedIndex;
    ...
    public SingleShootingGame(Image[] playerImages, int selectedIndex) {
        ...
        bossImage = new ImageIcon(Objects.requireNonNull(SingleShootingGame.class.getResource("중간보스.png"))).getImage();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (finalBossStage && finalBoss != null) {
            ...
            if (bossShootTick % 40 == 0) {
                bossBullets.add(new BossBullet(finalBoss.x + finalBoss.w / 3, finalBoss.y + finalBoss.h, 18, 44, 10));
                bossBullets.add(new BossBullet(finalBoss.x + finalBoss.w * 2 / 3, finalBoss.y + finalBoss.h, 18, 44, 10));
            }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (bossStage && boss != null) {
            if (bossImage !=null)
                g.drawImage(bossImage, boss.x, boss.y, boss.w, boss.h,this); //가은 수정 중간 보스 이미지
            else{
